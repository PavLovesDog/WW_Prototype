...
public class WMG_WeatherManager : MonoBehaviour
{
    ...
    public void InitializeSkyValues(float cloudShapeFactor, float cloudDensity)
    {
        cloudsSettings.shapeFactor.value = cloudShapeFactor;
        cloudsSettings.densityMultiplier.value = cloudDensity;
    }
